...
import profileOne from "../../assets/user-01.png";
import profileTwo from "../../assets/user-03.png";
import profileThree from "../../assets/user-11.png";
import profileFour from "../../assets/user-12.png";
...
<Image src={profileOne} alt="Profile One" height={100} width={50} />
<Image src={profileTwo} alt="Profile Two" height={100} width={50}/>
<Image src={profileThree} alt="Profile Three" height={100} width={50}/>
<Image src={profileFour} alt="Profile Four" height={100} width={50}/>
        </div>
        </div>
<RecentActivity />
      </div>
